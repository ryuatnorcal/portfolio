...
const Menu = () => {
  ...
  return (
    <div className='w-screen overflow-hidden'>
      <nav className="flex w-screen overflow-x-hidden justify-between items-center pt-3 pb-3 fixed w-full bg-white">
        ...
        <div onClick={handleMenu} className="lg:hidden">
          {open ?
            <Image src={close} alt="close" className="cursor-pointer mr-4" />
            : <Image src={menu} alt="menu" className="cursor-pointer mr-4" />
          }
        </div>
      </nav>
      {/* Mobile menu below */}
